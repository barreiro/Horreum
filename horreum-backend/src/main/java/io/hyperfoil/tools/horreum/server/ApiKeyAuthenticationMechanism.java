 ...
 */
@ApplicationScoped public class ApiKeyAuthenticationMechanism implements HttpAuthenticationMechanism {
    ...
    @Override public Uni<SecurityIdentity> authenticate(RoutingContext context, IdentityProviderManager identityProviderManager) {
        ...
        return headerValue == null ? Uni.createFrom().nullItem() : identityProviderManager.authenticate(new Request(headerValue));
    }
